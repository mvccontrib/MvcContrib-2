...
namespace MvcContrib
{
    public static class ObjectExtensions
    {
        ...
        public static TResult ReadNullableValue<T, TResult>(this Nullable<T> obj, Func<T, TResult> func)
            where T : struct
        {
            return ReadNullableValue(obj, func, default(TResult));
        }

        public static TResult ReadNullableValue<T, TResult>(this Nullable<T> obj, Func<T, TResult> func, TResult defaultValue)
            where T : struct
        {
